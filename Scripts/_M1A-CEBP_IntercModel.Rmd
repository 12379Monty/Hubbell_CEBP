...
bibliography: [../bib/Proteomics.bib, ../bib/bibFile.bib, ../bib/MCED.bib]
...
write_tsv(text_options_df,
 path=file.path(tables_DIR, ("reports/%s_%s_text_data_set.tsv",date_code,base_detect_code)) 
...
<!-- To run
# nohup Rscript -e "knitr::knit2html('_M1A-CEBP_IntercModel.Rmd')" > _M1A-CEBP_IntercModel.log  &

# Or
# nohup Rscript -e "rmarkdown::render('_M1A-CEBP_IntercModel.Rmd')" > _M1A-CEBP_IntercModel.log  &
